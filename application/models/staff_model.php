...
class Staff_model extends CI_Model{
	...
	function user_hospital($user_id = false){
		...
		$this->db->select("hospital.hospital_id,hospital,hospital_short_name,description,place,district.district,state.state,logo,telehealth,helpline.helpline as helpline,helpline.note as helpline_note,CONCAT(hospital_short_name,' - ',IFNULL(place,''),' - ',IFNULL(district.district,''),' - ',IFNULL(state.state,'')) as customdata",false)->from('user')
