...
class documentation extends CI_Controller {
	...
	function edit_document($document_id){
        ...
        $this->data['report']=$this->documentation_model->get_document_record($document_id);						
		$this->load->view('templates/header', $this->data);				
        $this->load->view('templates/leftnav');
		...
		{        
            ...
            // Add document record
		    if ($uploadOk ==1 && $this->documentation_model->update_document($document_id, $file['file_name'])){							
                $this->data['msg']="Document Edited Succesfully";					
            }
            else {
                $this->data['msg'] = $msg;
            }
