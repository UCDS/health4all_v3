        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
			...
			<?php
				...
				?>
				<?php if($f->user_function=="OP Detail" || $f->user_function=="completed_calls_report" || $f->user_function=="missed_calls_report" ||  $f->user_function=="appointment_by_staff" ||  $f->user_function=="login_report" ||  $f->user_function=="patient_location_report" ||  $f->user_function=="helpline_receiver"){ $more_reports=1; ?>
           ...
           <!--       		<li><a href="<?php echo base_url()."report/get/vitals_report";?>"><i class="glyphicon glyphicon-heart"></i> Vitals Report</a></li> -->
			...
			if($f->user_function=="create_appointment"){ ?>	
                        ...
                        <?php	}
                        if($f->user_function=="appointment_status"){ ?>	
                                <li><a href="<?php echo base_url()."reports/appointments_status";?>">Appointment Status</a></li>
                        <?php	}
