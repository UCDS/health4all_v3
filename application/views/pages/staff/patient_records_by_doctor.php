...
$(function(){
  ...
  function fnExcelReport() {
    ...
    <h4><CENTER>Doctor Activity - Patient Registration</CENTER></h4>	
    <?php echo form_open("staff_report/get_doctor_activity",array('role'=>'form','class'=>'form-custom')); ?>
        ...
        <table class="table table-bordered table-striped" id="table-sort">
            ...
            <tbody>
                <?php 
                    $total_entries = 0;
                    $index = 1;
                    foreach($patient_records_by_doctor as $records){
                ?>
                <tr>
