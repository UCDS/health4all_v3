...
$(function(){
  ...
  function fnExcelReport() {
    ...
    $('#test').attr('download', 'staff_activity-patient_registration.xls');
    ...
    <h4><CENTER>Staff Activity -Patient Registration</CENTER></h4>	
    <?php echo form_open("staff_report/get_patient_records",array('role'=>'form','class'=>'form-custom')); ?>
...
<br />
        ...
        <?php 
            if(isset($patient_records_by_staff) && count($patient_records_by_staff) > 0){
	  ...
	  <tr>
            ...
            <tbody>
                <?php 
                    $total_entries = 0;
                    $index = 1;
                    foreach($patient_records_by_staff as $records){
                ?>
                <tr>
                ...
                <?php 
                    ...
                    ?>
                <tr>
                    <td class="text-right" colspan="3">Total Entries</td>
