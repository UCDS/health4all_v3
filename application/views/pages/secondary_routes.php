		...
		<div class="row" style="margin-top:2%;">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
				<div class="form-group">
					...
					<select name="route_primary_id" required class="form-control">
					<option value="0">Choose option</option>
						<?php foreach($get_all_primary_routes_dd as $d){ ?>
							<option <?php if($edit_secondary_route['route_primary_id']==$d->route_primary_id){ echo "selected"; }?> value="<?php echo $d->route_primary_id; ?>"><?php echo $d->route_name; ?></option>
						<?php } ?>
					</select>
				</div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
				<div class="form-group">
					<label for="inputroutesecondary ">Add Route Secondary <span class="mandatory" style="color:red;">*</span> </label>
					<input class="form-control" name="route_secondary" id="inputroutesecondary" 
...
<?php 
	...
	$total_records = $all_secondary_routes_count[0]->count ;
