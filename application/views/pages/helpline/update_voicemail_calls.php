			...
			<?php
				...
				foreach($calls as $call){ ?>
					<tr>
						...
						<td>
							<select name="caller_type_<?php echo $call->call_id;?>"  id="caller_type_<?php echo $call->call_id;?>" style="width:100px" class="form-control" readonly>
						...
						<td>
							<select name="call_category_<?php echo $call->call_id;?>" id="call_category_<?php echo $call->call_id;?>" style="width:100px" class="form-control" readonly>
								<option value="">Select</option>
								<?php foreach($call_category as $cc){ ?>
									<option value="<?php echo $cc->call_category_id;?>"
						...
						<td>
							<select name="resolution_status_<?php echo $call->call_id;?>" style="width:100px" class="form-control" readonly>
								<option value="">Select</option>
							...
							<input class="date form-control" name="resolution_date_<?php echo $call->call_id;?>" value="<?php if($call->resolution_date_time != 0) echo date("d-M-Y",strtotime($call->resolution_date_time)); else echo '';?>" placeholder="Resolution Date" readonly />
							<input class="time form-control" name="resolution_time_<?php echo $call->call_id;?>" value="<?php if($call->resolution_date_time != 0) echo date("g:i A",strtotime($call->resolution_date_time)); else echo '';?>" placeholder="Resolution Time" readonly />
						</td>
						<td>
							<select name="hospital_<?php echo $call->call_id;?>" id="hospital_<?php echo $call->call_id;?>" style="width:100px" class="form-control" readonly>
								<option value="">Select</option>
						...
						<td>
							<select name="visit_type_<?php echo $call->call_id;?>" id="visit_type_<?php echo $call->call_id;?>" style="width:100px" class="form-control" readonly>
								<option value="">Select</option>
									<option value="OP"
