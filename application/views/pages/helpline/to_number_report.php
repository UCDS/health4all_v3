...
<?php echo form_open('dashboard/to_number_report/',array('role'=>'form','class'=>'form-custom')); ?>
<div class="col-md-12">
			<span style="font-size:24px;font-weight:bold"><span class="flaticon-telephone-line-24-hours-service"></span> Helpline - To Number<br/>
			<div class="col-md-3">
