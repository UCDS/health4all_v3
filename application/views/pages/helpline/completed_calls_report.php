...
<div class="row">
	...
	<?php
			...
			echo form_open('helpline/completed_calls_report',array('role'=>'form','class'=>'form-custom','id'=>'call_detailed_report','name'=>'call_detailed_report' ));
	?>
				...
				foreach($calls as $call){ ?>
					<tr>
						...
						<td style="text-align:right">
							<?php echo $call->customers;?>
						</td>
						
						<td style="text-align:right">
							<?php echo $call->incoming_calls;?>
						</td>
						
						<td style="text-align:right">
							<?php echo $call->outboundcalls;?>
						</td>
