...
<h5>Page <?php echo $page_no." of ".$total_no_of_pages." (Total ".$total_records.")" ; ?></h5>
	...
	<tr>
		...
		<td><?php echo $s->ip_department;?></td>
		<td><?php if(isset($s->latest_ip_no) && $s->latest_ip_no!="") {
		...
		<td><?php
		 ...
		 echo $s->outcome." , ".date("j M Y", strtotime("$s->outcome_date"))." ".date("h:i A.", strtotime("$s->outcome_time"))  ;
		 }
		 ?>
		 </td>		
