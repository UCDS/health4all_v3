...
function fnExcelReport() {
    ...
    $('#test').attr('download', 'visit_type_summary.xls');
	...
	?>
	<div class="row">
		<h4>IP/OP Visit Summary</h4>	
		<?php echo form_open("reports/visit_type_summary",array('role'=>'form','class'=>'form-custom')); ?>
                <b>Visit Type:  </b>
	...
	<thead>
	<tr>
		<th style="text-align:center" rowspan="2">Visit Type</th>
	...
	?>
	<tr>
		<td class="text-left"><?php echo $s->visit_name;?></td>
