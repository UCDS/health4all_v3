			...
			<div class="col-md-12">
				<div class="col-md-4">
					<div class="form-group">
						...
						value="<?php echo $edit_unit_name['unit_head_staff_id']; ?>" placeholder="unit head staff id"name="unit_head_staff_id" id="inputunit_head_staff_id" >
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" 
						value="<?php echo $edit_unit_name['unit_name']; ?>" placeholder="unit name"name="unit_name" id="unit_name" required
						 >
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						...
						<?php 
								if(!empty($edit_unit_name['department_id'])) 
								{ 
									foreach($all_departments as $adname)
									{
										if($adname->department_id == $edit_unit_name['department_id'])
										{
								...
								?>
									...
									{ 
									?>
									<option <?php if($edit_unit_name['department_id']==$dept->department_id) { echo "selected"; }?> value="<?php echo $dept->department_id?>"> <?php echo $dept->department; ?> </option>
									<?php
									}
									?>
									</select>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" 
						value="<?php echo $edit_unit_name['beds']; ?>" placeholder="bed id"name="beds" id="beds">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label for="inputlab_report_staff_id ">Lab Report Staff </label>
							...
							{
							?>
							<option <?php if($edit_unit_name['lab_report_staff_id']==$lab->staff_id) { echo "selected"; }?> value="<?php echo $lab->staff_id?>"> <?php echo $lab->staff_name; ?> </option>
							<?php 
							}
							?>
							</select>
			    ...
			    <input type="hidden" name="record_id" value="<?php echo $edit_unit_name['unit_id']; ?>" >
				<?php if(!empty($edit_unit_name)) { ?>
...
<?php if(isset($all_unit_name) && count($all_unit_name)>0)
{ ?>
...
<?php 
	...
	$total_records = $all_unit_name_count[0]->count ;
...
<h5>Page <?php echo $page_no." of ".$total_no_of_pages." (Total ".$total_records.")" ; ?></h5>
	...
	<thead>
		...
		<th style="text-align:center">Unit Head Staff</th>		
	...
	foreach($all_unit_name as $aun) { 
	?>
	<tr>
		<td style="text-align:right"><?php echo $sno;?></td>	
		<td ><?php echo $aun->unit_name; ?></td>	
		<td ><?php echo $aun->dname; ?></td>	
		<td style="text-align:right"><?php echo $aun->beds; ?></td>	
		<td style="text-align:right"><?php echo $aun->unit_head_staff_id; ?></td>	
		<td ><?php echo $aun->fname; ?></td>	
		<td style="text-align:center;">
		<a class="btn btn-success" href="<?php echo base_url('hospital_units/add_unit/'.$aun->unit_id); ?>" style="color:white!important;">Edit</a></td>
	</tr>
	<?php $sno++;}	?>
	</tbody>
	</table>
