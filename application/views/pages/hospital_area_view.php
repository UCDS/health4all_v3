...
display: inline-grid;
	...
	<h2><?php echo $title; ?></h2>
		<?php if(!empty($edit_area)) { ?>
			<?php echo form_open('hospital_areas/update_area',array('class'=>'form-group','role'=>'form','id'=>'appointment')); ?>
		<?php } else { ?>
			<?php echo form_open('hospital_areas/add_area',array('class'=>'form-group','role'=>'form','id'=>'appointment')); ?> 
		<?php } ?>
			...
			<div class="col-md-12">
				<div class="col-md-4">
					<div class="form-group">
						...
						<input class="form-control" name="area_name"  id="inputarea_name" 
						value="<?php echo $edit_area['area_name']; ?>" placeholder="enter name" type="TEXT" align="middle" 
						 required>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label for="inputdepartment_id">Department</label>
							<?php 
								if(!empty($edit_area['department_id'])) 
								{ 
									foreach($all_departments as $adname)
									{
										if($adname->department_id == $edit_area['department_id'])
										{
								...
								?> 
									...
									{ 
									?>
									<option <?php if($edit_area['department_id']==$dept->department_id) { echo "selected"; }?> value="<?php echo $dept->department_id?>"> <?php echo $dept->department; ?> </option>
									<?php
									}
									?>
									</select>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input class="form-control" name="beds" id="inputbeds" 
						value="<?php echo $edit_area['beds']; ?>" placeholder="enter no of beds" type="text">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label for="inputarea_type_id ">Area Type </label>
							...
							{
							?>
							<option <?php if($edit_area['area_type_id']==$area->area_type_id) { echo "selected"; }?> value="<?php echo $area->area_type_id?>"> <?php echo $area->area_type; ?> </option>
							<?php
							}
							?>
							</select>
				...
				<div class="col-md-4">
					<div class="form-group">
						<label for="inputlab_report_staff_id ">Lab Report Staff </label>
							...
							{
							?>
							<option <?php if($edit_area['lab_report_staff_id']==$lab->staff_id) { echo "selected"; }?> value="<?php echo $lab->staff_id?>"> <?php echo $lab->staff_name; ?> </option>
							<?php 
							}
							?>
							</select>
			    ...
			    <input type="hidden" name="record_id" value="<?php echo $edit_area['area_id']; ?>" >
				<?php if(!empty($edit_area)) { ?>
...
<?php if(isset($all_areas) && count($all_areas)>0)
{ ?>
<div style='padding: 0px 2px;'>

<h3>List Areas</h3>
	<?php  echo form_open('hospital_areas/get_all_area',array('role'=>'form','class'=>'form-custom','id'=>'appointment')); ?>
...
<?php 
	...
	$total_records = $all_areas_count[0]->count ;
...
<h5>Page <?php echo $page_no." of ".$total_no_of_pages." (Total ".$total_records.")" ; ?></h5>
	...
	<thead>
		...
		<th style="text-align:center">Lab Report Staff</th>				
	...
	foreach($all_areas as $aa) { 
	?>
	<tr>
		<td style="text-align:right"><?php echo $sno;?></td>	
		<td style="text-align:center"><?php echo $aa->area_name; ?></td>	
		<td style="text-align:center"><?php echo $aa->dname; ?></td>	
		<td style="text-align:right"><?php echo $aa->beds; ?></td>	
		<td style="text-align:center"><?php echo $aa->atype; ?></td>	
		<td style="text-align:center"><?php echo $aa->first_name; ?></td>	
		<td style="text-align:center;">
		<a class="btn btn-success" href="<?php echo base_url('hospital_areas/add_area/'.$aa->area_id); ?>" style="color:white!important;">Edit</a></td>
	</tr>
	<?php $sno++;}	?>
	</tbody>
	</table>
