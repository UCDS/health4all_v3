...
function onchange_page_dropdown(dropdownobj){
   doPost(dropdownobj.value);    
    ...
    <h3>
	<CENTER>
		Followup Summary Death - Routes
	  </CENTER></h3><br>
		<?php echo form_open("op_ip_report/followup_summary_death_routes",array('role'=>'form','class'=>'form-custom')); ?>
			<div class="container">
				<div class="row">
					<div class="col-md-4">
					<label><b>Life Status:  </b></label>
						<input type="radio" name="life_status" class ="form-control" value="2" <?php if(empty($this->input->post('life_status')) || $this->input->post('life_status') == 2) {echo "checked" ;} ?>  > 
		...
		<table class="table table-bordered table-striped" id="table-sort">
			<thead>
				<tr>
					...
					<th style="text-align:center;">Other Centre</th>						
			...
			<tbody>
				...
				foreach($report as $s)
				{
					...
					$total_home+=$s->home;
					$total_unupdated_death+=$s->unupdated_death;
				...
				<tr>
					...
					<td style="text-align:right;"><?php echo $s->unupdated_death ?></td>
					
					<td style="text-align: center">
						<?php 
							echo $tot = $s->centre+$s->otherCentre+$s->home+$s->unupdated_death;
						?>
					</td>
				</tr>
				<?php $sno++;} 	?>
			...
			<tfoot>
				<tr>
					...
					<?php echo $total_unupdated_death; ?>
					</th>
					<th style="text-align:center;">
						<?php echo $total_centre+$total_otherCentre+$total_home+$total_unupdated_death; ?>
					</th>
				</tr>
			</tfoot>
	</table>
