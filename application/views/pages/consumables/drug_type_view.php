		...
		<div class="row" style="margin-top:2%;">
			<div class="col-md-3">
					<div class="form-group">
						<label for="drug type">Add Drug Type<font style="color:red">*</font></label>
						<input type="text" class="form-control" placeholder="Enter Drug Type" id="drug_type" name="drug_type"
						value="<?php echo $edit_drug_type['drug_type']; ?>" autocomplete="off" required>
					</div>
			</div>
			<div class="col-md-5">
					<div class="form-group">
						<label for="Inputdescription">Description</label>
						<textarea class="form-control" id="desc" name="description" rows="2" 
						value="<?php echo $edit_drug_type['description']; ?>" placeholder="Enter Description about Drug Type">
						<?php echo $edit_drug_type['description']; ?>
						</textarea>
					</div>
					<script>
						ClassicEditor
...
<?php if(isset($all_drug_type) && count($all_drug_type)>0)
{ ?>
...
<?php 
	...
	$total_records = $all_drug_type_count[0]->count ;
...
<h5>Page <?php echo $page_no." of ".$total_no_of_pages." (Total ".$total_records.")" ; ?></h5>
	...
	foreach($all_drug_type as $adt) { 
	?>
	<tr>
		<td style="text-align:right"><?php echo $sno;?></td>	
		<td style="text-align:center"><?php echo $adt->drug_type; ?></td>	
		<td style="text-align:center"><?php echo $adt->description; ?></td>	
		<td style="text-align:center"><?php echo $adt->first_name; ?></td>	
		<td style="text-align:center"><?php echo $adt->updated_by_name; ?></td>	
		<td style="text-align:center"><?php if($adt->created_date_time!=''){ echo date("j M Y h:i A.", strtotime("$adt->created_date_time")); } ?></td>	
		<td style="text-align:center">
			<?php if($adt->updated_date_time!=''){ echo date("j M Y h:i A.", strtotime("$adt->updated_date_time")); } ?>
		</td>	
		<td style="text-align:center;">
		<a class="btn btn-success" href="<?php echo base_url('consumables/drug_type/add_drug_type/'.$adt->drug_type_id); ?>" style="color:white!important;">Edit</a></td>
	</tr>
	<?php $sno++;}	?>
	</tbody>
	</table>
