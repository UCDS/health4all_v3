...
<?php if(isset($all_dosage_type) && count($all_dosage_type)>0)
{ ?>
...
<?php 
	...
	$total_records = $all_dosage_type_count[0]->count ;
...
<h5>Page <?php echo $page_no." of ".$total_no_of_pages." (Total ".$total_records.")" ; ?></h5>
	...
	<thead>
		...
		<th style="text-align:center">Dosage Unit</th>
	...
	foreach($all_dosage_type as $adt) { 
	?>
	<tr>
		<td style="text-align:right"><?php echo $sno;?></td>	
		<td style="text-align:center"><?php echo $adt->dosage_unit; ?></td>	
		<td style="text-align:center"><?php echo $adt->dosage; ?></td>	
		...
		<td style="text-align:center;">
		<a class="btn btn-success" href="<?php echo base_url('consumables/dosage/add_dosage/'.$adt->dosage_id); ?>" style="color:white!important;">Edit</a></td>
	</tr>
	<?php $sno++;}	?>
	</tbody>
	</table>
