...
<script>
	...
	function fnExcelReport() 
	{
		...
		$('#test').attr('download', 'inventory_item_detail.xls');
  	}
</script>
	<?php
	...
	?>
			   <div class="text-center">
				...
				<?php echo form_open('consumables/indent_reports/get_item_inventory_detail',array('class'=>'form-group','role'=>'form','id'=>'evaluate_applicant')); ?>
				<div class="container">
					<div class="row">
										...
										foreach($item_form as $i)
											{
												...
												echo $this->input->post('item_form') == $i->item_form_id ? " selected": "";
							...
							<label for="generic_item" >Generic Item</label>
								<select name="generic_item" id="generic_item" class="form-control" placeholder="Select">
									...
									foreach ($generic_item as $i) {
										...
										echo $this->input->post('generic_item') == $i->generic_item_id ? " selected" : "";
		  ...
		  <?php echo form_open('consumables/indent_reports/get_item_inventory_detail',array('role'=>'form'))   ?>
	...
	<div class="container" >	
		<div class="col-md-offset-2" >
			<div id="print-container">
				<?php 
					foreach($search_inventory_summary as $sis)
					{
						if($sis->inward_outward=='inward')
						{
							$opening_balance+=$sis->total_quantity;
						}
					}
				?>
				<?php if(count($search_inventory_summary) > 0) { ?>
					<?php
						foreach($parties as $scp)
						{
							...
							echo '<h3 style="text-align:center;"><span > Party : </span>'.
					...
					<tr>
						...
						?>
							...
							<td style="text-align:right;">
								...
								if($tot_outward_balance>$tot_outward_balance)
								{
