...
display: inline-grid;
	...
	<h2><?php echo $title; ?></h2>	
		...
		<?php } else { ?>
			<?php echo form_open('consumables/item_form/item_forms_list',array('class'=>'form-group','role'=>'form','id'=>'appointment')); ?> 
		<?php } ?>
		<input type="hidden" name="page_no" id="page_no" value='<?php echo "$page_no"; ?>'>
		<div class="row" style="margin-top:2%;">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
				<div class="form-group">
					<label for="item_form_id">Add Item Form<font style="color:red">*</font></label>
					<input type="text" class="form-control" placeholder="Enter Item Form" id="item_form_id" name="item_form_id" 
					value="<?php echo $edit_item_form['item_form']; ?>" required autocomplete="off">
				</div>
				 <?php 
			...
			<div class="col-md-2">
				<label for="item_form_id">Rows per page</label>
				...
				<input type="hidden" name="record_id" value="<?php echo $edit_item_form['item_form_id']; ?>" >
			</div>
				<?php if(!empty($edit_item_form)) { ?>
...
<?php if(isset($all_item_form) && count($all_item_form)>0)
{ ?>
...
<?php 
	...
	$total_records = $all_item_form_count[0]->count ;
...
<h5>Page <?php echo $page_no." of ".$total_no_of_pages." (Total ".$total_records.")" ; ?></h5>
	...
	<thead>
		...
		<th style="text-align:center">Item Form</th>
	...
	foreach($all_item_form as $aif) { 
	?>
	<tr>
		<td style="text-align:right"><?php echo $sno;?></td>	
		<td style="text-align:center"><?php echo $aif->item_form; ?></td>	
		<td style="text-align:center"><?php echo $aif->first_name; ?></td>	
		<td style="text-align:center"><?php echo $aif->updated_by_name; ?></td>	
		<td style="text-align:center"><?php if($aif->created_date_time!=''){ echo date("j M Y h:i A.", strtotime("$aif->created_date_time")); } ?></td>	
		<td style="text-align:center">
			<?php if($aif->updated_date_time!=''){ echo date("j M Y h:i A.", strtotime("$aif->updated_date_time")); } ?>
		</td>	
		<td style="text-align:center;">
		<a class="btn btn-success" href="<?php echo base_url('consumables/item_form/item_forms_list/'.$aif->item_form_id); ?>" style="color:white!important;">Edit</a></td>
	</tr>
	<?php $sno++;}	?>
	</tbody>
	</table>
