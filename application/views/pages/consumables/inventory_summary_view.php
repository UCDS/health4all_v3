		 ...
		 <div class="col-md-offset-2">
			...
			<?php
				...
				foreach($search_inventory_summary as $inventory_item){?>
					...
					<tr>
					<?php echo $i++; $sub_url="consumables/indent_reports/get_indent_detailed/";
					$item_type_id = '0';
					if ($inventory_item['inward']->item_id) {
						...
						<!-- <td><a href="<?php// echo base_url().$sub_url."$from_date/$to_date/$from_party/$to_party/0/$item_type_id/".$inventory_item->item_id.";"?>"><?php //echo $inventory_item->item_type;?></td> -->
						<td><a href="<?php echo base_url().$sub_url?>"><?php echo $inventory_item['inward']->item_name;?></td>
						<td><a href="<?php echo base_url().$sub_url?>"><?php echo $inventory_item['inward']->supply_chain_party_name;?></td>
						<td><a href="<?php echo base_url().$sub_url?>"><?php echo $inventory_item['inward']->total_quantity;?></td>
						<td><a href="<?php echo base_url().$sub_url?>"><?php echo $inventory_item['outward']->total_quantity;?></td>
						<td><a href="<?php echo base_url().$sub_url?>"><?php echo ($inventory_item['inward']->total_quantity - $inventory_item['outward']->total_quantity);?></td>
