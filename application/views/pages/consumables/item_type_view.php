...
display: inline-grid;
	...
	<h2><?php echo $title; ?></h2>	
		<?php if(!empty($edit_item_type)) { ?>
			<?php echo form_open('consumables/item_type/update_item_type',array('class'=>'form-group','role'=>'form','id'=>'appointment')); ?>
		<?php } else { ?>
			<?php echo form_open('consumables/item_type/add_item_type',array('class'=>'form-group','role'=>'form','id'=>'appointment')); ?> 
		<?php } ?>
		<input type="hidden" name="page_no" id="page_no" value='<?php echo "$page_no"; ?>'>
		<div class="row" style="margin-top:2%;">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
				<div class="form-group">
					<label for="item_type">Add Item type<font style="color:red">*</font></label>
					<input type="text" class="form-control" placeholder="Enter Item Type" id="item_type" name="item_type" 
					value="<?php echo $edit_item_type['item_type']; ?>" required autocomplete="off">
				</div>
				 <?php 
			...
			<div class="col-md-2">
				<label for="item_type">Rows per page</label>
				...
				<input type="hidden" name="record_id" value="<?php echo $edit_item_type['item_type_id']; ?>" >
				<?php if(!empty($edit_item_type)) { ?>
...
<?php if(isset($all_item_type) && count($all_item_type)>0)
{ ?>
...
<?php 
	...
	$total_records = $all_item_type_count[0]->count ;
...
<h5>Page <?php echo $page_no." of ".$total_no_of_pages." (Total ".$total_records.")" ; ?></h5>
	...
	foreach($all_item_type as $ait) { 
	?>
	<tr>
		<td style="text-align:right"><?php echo $sno;?></td>	
		<td style="text-align:center"><?php echo $ait->item_type; ?></td>	
		<td style="text-align:center"><?php echo $ait->first_name; ?></td>	
		<td style="text-align:center"><?php echo $ait->updated_by_name; ?></td>	
		<td style="text-align:center"><?php if($ait->created_date_time!=''){ echo date("j M Y h:i A.", strtotime("$ait->created_date_time")); } ?></td>	
		<td style="text-align:center">
			<?php if($ait->updated_date_time!=''){ echo date("j M Y h:i A.", strtotime("$ait->updated_date_time")); } ?>
		</td>	
		<td style="text-align:center;">
		<a class="btn btn-success" href="<?php echo base_url('consumables/item_type/add_item_type/'.$ait->item_type_id); ?>" style="color:white!important;">Edit</a></td>
	</tr>
	<?php $sno++;}	?>
	</tbody>
	</table>
