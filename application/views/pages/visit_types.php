...
display: inline-grid;
	...
	<h2><?php echo $title; ?></h2>
		<?php if(!empty($edit_visit_type)) { ?>
			<?php echo form_open('user_panel/update_visit_type',array('class'=>'form-group','role'=>'form','id'=>'appointment')); ?>
		<?php } else { ?>
			<?php echo form_open('user_panel/visit_type',array('class'=>'form-group','role'=>'form','id'=>'')); ?> 
		<?php } ?>
		<input type="hidden" name="page_no" id="page_no" value='<?php echo "$page_no"; ?>'>
		<div class="row" style="margin-top:2%;">
			<div class="col-md-12">
				<div class="form-group col-md-4">
					<label for="inputrouteprimary ">Add Visit Name <span class="mandatory" style="color:red;">*</span> </label>
					<input class="form-control" name="visit_name" id="inputrouteprimary" 
					placeholder="Enter Visit Name" type="text" 
					value="<?php echo $edit_visit_type['visit_name'] ?>" autocomplete="off" required>
				</div>
				<div class="form-group col-md-4">
					<label for="inputrouteprimary ">Inuse <span class="mandatory" style="color:red;">*</span> </label>
					<select name="inuse" required class="form-control">
						<option value="">Choose Inuse</option>
						<option <?php if($edit_visit_type['inuse']==1){ echo "selected"; }?> value="1">Yes</option>
				...
				<div class="form-group col-md-4">
					...
					<input type="hidden" name="record_id" value="<?php echo $edit_visit_type['visit_name_id']; ?>" >
					<?php if(!empty($edit_visit_type)) { ?>
...
<?php if(isset($all_visit_type) && count($all_visit_type)>0)
{ ?>
...
<?php 
	...
	$total_records = $all_visit_type_count[0]->count ;
...
<h5>Page <?php echo $page_no." of ".$total_no_of_pages." (Total ".$total_records.")" ; ?></h5>
	...
	<tr>
		...
		<td style="text-align:center">
			<?php if($avt->updated_date_time!=''){ echo date("j M Y h:i A.", strtotime("$avt->updated_date_time")); } ?>
		</td>	
		<td style="text-align:center;">
		<a class="btn btn-success" href="<?php echo base_url('user_panel/visit_type/'.$avt->visit_name_id); ?>" style="color:white!important;">Edit</a></td>
	</tr>
	<?php $sno++;}	?>
	</tbody>
	</table>
