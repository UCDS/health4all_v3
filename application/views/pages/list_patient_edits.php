...
<div class="row">
		...
		<?php echo form_open("patient/list_patient_edits",array('role'=>'form','class'=>'form-custom','id'=>'appointment')); ?> 
...
<?php if(isset($patient_edits) && count($patient_edits)>0)
{ ?>
...
<?php 
	...
	$total_records = $patient_edits_count[0]->count ;
...
<h5>Page <?php echo $page_no." of ".$total_no_of_pages." (Total ".$total_records.")" ; ?></h5>
	...
	<thead>
		...
		<th style="text-align:center">Edit date/time</th>
	...
	foreach($patient_edits as $pe){
	?>
	<tr>
		<td style="text-align:right"><?php echo $sno;?></td>
		<td style="text-align:right"><?php echo $pe->patient_id; ?></td> 	
		<td style="text-align:right"><?php echo $pe->first_name; ?></td> 	
		...
		<td style="text-align:center"><?php echo date("d-M-Y",strtotime($pe->edit_date_time));?></td>
		<td style="text-align:center"><?php echo $pe->staff_name; ?> </td>
	</tr>
	<?php $sno++;}	?>
	</tbody>
	</table>
