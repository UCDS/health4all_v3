		...
		<?php echo form_open("op_ip_report/followup_summary",array('role'=>'form','class'=>'form-custom')); ?>
			<div class="container">
				<div class="row">
					...
					<div class="col-md-7" id="followupadd_date" style="width:500px!important;">
					<?php 
			...
			<tfoot>
				<tr>
					...
					<th style="text-align:right;">
						<?php echo $total_unupdated_priority; ?>
					</th>
					<th style="text-align:center;">
						<?php echo 
						$tot = $total_highcount+$total_mediumcount+$total_lowcount+$total_unupdated_priority; ?>
					</th>
				</tr>
			</tfoot>
	</table>
